...
import { Activity, BarChart2, MapPin, CheckCircle, XCircle, LogOut, Filter, Calendar, ChevronLeft, ChevronRight, User, Lock } from 'lucide-react';
import axios from 'axios';

// ★修正: Firebase設定のインポート
import { auth, googleProvider } from './firebaseConfig';

// ★修正: FirebaseのUser型を 'import type' で明示的にインポート
...
export default function App() {
  ...
  // ★追加: 認証状態の監視
  // 修正: user引数にFirebaseUser | nullの型定義を追加し、any型エラーを回避
  useEffect(() => {
